...
class UI_SettingsDialog(QtWidgets.QDialog):
    ...
    def accept(self):
        ...
        settings.setValue("column1Visible", int(self.checkBox_1.isChecked()))
        settings.setValue("column2Visible", int(self.checkBox_2.isChecked()))
        settings.setValue("column3Visible", int(self.checkBox_3.isChecked()))
        settings.setValue("column4Visible", int(self.checkBox_4.isChecked()))
        settings.setValue("column5Visible", int(self.checkBox_5.isChecked()))
    ...
    def reject(self):
        ...
        self.checkBox_1.setChecked(int(settings.value("column1Visible", 1)))
        self.checkBox_2.setChecked(int(settings.value("column2Visible", 1)))
        self.checkBox_3.setChecked(int(settings.value("column3Visible", 1)))
        self.checkBox_4.setChecked(int(settings.value("column4Visible", 1)))
        self.checkBox_5.setChecked(int(settings.value("column5Visible", 1)))
